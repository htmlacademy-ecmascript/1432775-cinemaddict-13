...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EMOTIONS, EMOTION_PICS, SortType, CATEGORIES */
...
class Catalog {
  ...
  init(films, user, container) {
    ...
    Object(_util_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._siteMain.parentElement.querySelector(`.header`), this._userIconView);
...
class CardPresenter {
  ...
  _openPopup(evt) {
    evt.preventDefault();
    this._closePopups();
    this._popup = new _view_film_popup__WEBPACK_IMPORTED_MODULE_2__["default"](this._film, this.cardUpdateHandler);
