...
/* harmony import */ var _presenter_catalog_presenter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./presenter/catalog-presenter */ "./src/presenter/catalog-presenter.js");
/* harmony import */ var _presenter_filters_presenter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./presenter/filters-presenter */ "./src/presenter/filters-presenter.js");
/* harmony import */ var _model_films_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./model/films-model */ "./src/model/films-model.js");
/* harmony import */ var _model_filter_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./model/filter-model */ "./src/model/filter-model.js");
/* harmony import */ var _model_comments_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./model/comments-model */ "./src/model/comments-model.js");
...
const filmsModel = new _model_films_model__WEBPACK_IMPORTED_MODULE_7__["default"]();
filmsModel.setFilms(films);

const filterModel = new _model_filter_model__WEBPACK_IMPORTED_MODULE_8__["default"]();

const commentsModel = new _model_comments_model__WEBPACK_IMPORTED_MODULE_9__["default"]();
commentsModel.setComments(_mock_comments__WEBPACK_IMPORTED_MODULE_3__["comments"]);

const siteMain = document.querySelector(`.main`);

const filtersPresenter = new _presenter_filters_presenter__WEBPACK_IMPORTED_MODULE_6__["default"](filmsModel, filterModel);
filtersPresenter.init(siteMain);

const catalogPresenter = new _presenter_catalog_presenter__WEBPACK_IMPORTED_MODULE_5__["default"](filmsModel, filterModel, commentsModel);
catalogPresenter.init(user, siteMain);

const siteFooter = document.querySelector(`.footer`);
const footerStats = siteFooter.querySelector(`.footer__statistics`);
Object(_util_js__WEBPACK_IMPORTED_MODULE_4__["render"])(footerStats, new _view_films_number__WEBPACK_IMPORTED_MODULE_0__["default"](AVAILABLE_FILMS));
...
const generateComments = () => {
  ...
  const createNewComment = () => {
    return {
      id: Object(_const__WEBPACK_IMPORTED_MODULE_2__["generateId"])(),
      text: _const__WEBPACK_IMPORTED_MODULE_2__["DESCRIPTIONS"][Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_2__["DESCRIPTIONS"].length - 1)],
...
const generateDescription = () => {
  ...
  for (let i = 0; i < MAX_DESCRIPTION_SENTENCES; i++) {
    description.push(_const__WEBPACK_IMPORTED_MODULE_1__["DESCRIPTIONS"][Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_1__["DESCRIPTIONS"].length - 1)]);
  }
...
const generateCommentsIdArr = () => {
  let idArr = [];
  for (let i = 0; i < Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, MAX_COMMENTS_NUMBER); i++) {
    idArr.push(_comments__WEBPACK_IMPORTED_MODULE_2__["comments"][Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, _comments__WEBPACK_IMPORTED_MODULE_2__["comments"].length - 1)].id);
  }
  return idArr;
};
...
class MockFilm {
  constructor() {
    this._id = Object(_const__WEBPACK_IMPORTED_MODULE_1__["generateId"])();
...
class FilmModel extends _observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  updateFilm(elementToUpdate) {
    ...
    this.notify(_const__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].UPDATE_FILM, elementToUpdate);
  }
}
...
class Catalog {
  ...
  init(user, container) {
    ...
    this._siteMenuView = new _view_site_menu__WEBPACK_IMPORTED_MODULE_1__["default"](this._getFilms());
  ...
  _renderSort() {
    ...
    this._siteSortView = new _view_site_sort__WEBPACK_IMPORTED_MODULE_2__["default"](this._currentSortType);
