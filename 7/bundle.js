...
Object(_util_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteHeader, new _view_user_icon__WEBPACK_IMPORTED_MODULE_0__["default"](user.avatar, user.raiting));

const siteMain = document.querySelector(`.main`);
Object(_util_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMain, new _view_site_menu__WEBPACK_IMPORTED_MODULE_1__["default"](user), `afterbegin`);

const renderTheWholeCatalog = () => {
  const siteCatalog = new _view_films_catalog__WEBPACK_IMPORTED_MODULE_4__["default"](MOCK_FILMS < 1);
  ...
  Object(_util_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMain, new _view_site_sort__WEBPACK_IMPORTED_MODULE_2__["default"]());
  Object(_util_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMain, filmsContainer);
  ...
  Object(_util_js__WEBPACK_IMPORTED_MODULE_10__["render"])(filmsContainer, new _view_most_commented_container__WEBPACK_IMPORTED_MODULE_7__["default"]());
  ...
  for (let i = 0; i < Math.min(FILMS_MOST_COMMENTED_CARDS_NUMBER, filmsSortedByComments.length); i++) {
    Object(_render_card__WEBPACK_IMPORTED_MODULE_11__["renderCard"])(mostCommentedFilmsContainer, filmsSortedByComments[i]);
  }
};
...
Object(_util_js__WEBPACK_IMPORTED_MODULE_10__["render"])(footerStats, new _view_films_number__WEBPACK_IMPORTED_MODULE_3__["default"](AVAILABLE_FILMS));
...
const renderCard = (container, film) => {
  const card = new _view_film_card__WEBPACK_IMPORTED_MODULE_2__["default"](film);
