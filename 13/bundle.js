...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mock_user__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mock/user */ "./src/mock/user.js");
/* harmony import */ var _presenter_user_presenter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./presenter/user-presenter */ "./src/presenter/user-presenter.js");
/* harmony import */ var _presenter_catalog_presenter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./presenter/catalog-presenter */ "./src/presenter/catalog-presenter.js");
/* harmony import */ var _presenter_filters_presenter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/filters-presenter */ "./src/presenter/filters-presenter.js");
/* harmony import */ var _presenter_films_counter_presenter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/films-counter-presenter */ "./src/presenter/films-counter-presenter.js");
/* harmony import */ var _model_films_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/films-model */ "./src/model/films-model.js");
...
/* harmony import */ var _model_comments_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./model/comments-model */ "./src/model/comments-model.js");
...
const user = new _mock_user__WEBPACK_IMPORTED_MODULE_0__["default"]().userStats;
const api = new _api__WEBPACK_IMPORTED_MODULE_8__["default"](END_POINT, AUTHORIZATION);
const filmsModel = new _model_films_model__WEBPACK_IMPORTED_MODULE_5__["default"](api);
const filterModel = new _model_filter_model__WEBPACK_IMPORTED_MODULE_6__["default"]();
const commentsModel = new _model_comments_model__WEBPACK_IMPORTED_MODULE_7__["default"](api);
const siteMain = document.querySelector(`.main`);
const header = document.querySelector(`.header`);
const siteFooter = document.querySelector(`.footer`);
const footerStats = siteFooter.querySelector(`.footer__statistics`);

const userPresenter = new _presenter_user_presenter__WEBPACK_IMPORTED_MODULE_1__["default"](filmsModel);
userPresenter.init(header);

const filtersPresenter = new _presenter_filters_presenter__WEBPACK_IMPORTED_MODULE_3__["default"](filmsModel, filterModel);
filtersPresenter.init(siteMain);

const catalogPresenter = new _presenter_catalog_presenter__WEBPACK_IMPORTED_MODULE_2__["default"](filmsModel, filterModel, commentsModel);
catalogPresenter.init(user, siteMain);

const filmsCounterPresenter = new _presenter_films_counter_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](filmsModel);
...
/*!*********************!*\
  !*** ./src/util.js ***!
  \*********************/
/*! exports provided: getRandomInteger, createElement, render, replace, remove, isKeyPressed, updateUserPropertyArray, filter, getDuration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
