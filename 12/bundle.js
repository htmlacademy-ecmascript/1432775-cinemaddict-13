...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EMOTIONS, EMOTION_PICS, SortType, CATEGORIES, UserAction, UpdateType, ModelMethod */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _mock_user__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mock/user */ "./src/mock/user.js");
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util.js */ "./src/util.js");
/* harmony import */ var _presenter_catalog_presenter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/catalog-presenter */ "./src/presenter/catalog-presenter.js");
/* harmony import */ var _presenter_filters_presenter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/filters-presenter */ "./src/presenter/filters-presenter.js");
...
const user = new _mock_user__WEBPACK_IMPORTED_MODULE_1__["default"]().userStats;
...
const filtersPresenter = new _presenter_filters_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](filmsModel, filterModel);
filtersPresenter.init(siteMain);

const catalogPresenter = new _presenter_catalog_presenter__WEBPACK_IMPORTED_MODULE_3__["default"](filmsModel, filterModel, commentsModel);
catalogPresenter.init(user, siteMain);

const siteFooter = document.querySelector(`.footer`);
const footerStats = siteFooter.querySelector(`.footer__statistics`);
Object(_util_js__WEBPACK_IMPORTED_MODULE_2__["render"])(footerStats, new _view_films_number__WEBPACK_IMPORTED_MODULE_0__["default"](AVAILABLE_FILMS));
...
/*!***************************!*\
  !*** ./src/mock/const.js ***!
  \***************************/
/*! exports provided: DESCRIPTIONS, generateId */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
// Да, название файла частично не соответствует содержимому, но моки всё равно потом удалятся
...
class CommentsModel extends _observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  addComment(commentToAdd) {
    ...
    this.notify(_const_js__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].ADD_COMMENT, commentToAdd);
  }
...
/* harmony import */ var _view_site_sort__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/site-sort */ "./src/view/site-sort.js");
/* harmony import */ var _view_films_catalog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/films-catalog */ "./src/view/films-catalog.js");
...
/* harmony import */ var _view_top_raited_container__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/top-raited-container */ "./src/view/top-raited-container.js");
/* harmony import */ var _view_most_commented_container__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/most-commented-container */ "./src/view/most-commented-container.js");
/* harmony import */ var _view_loading__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/loading */ "./src/view/loading.js");
/* harmony import */ var _view_no_films__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/no-films */ "./src/view/no-films.js");
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../util.js */ "./src/util.js");
/* harmony import */ var _film_card_presenter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./film-card-presenter */ "./src/presenter/film-card-presenter.js");
...
class Catalog {
  constructor(filmsmodel, filterModel, commentsModel) {
    ...
    this._showMoreButton = new _view_show_more_button__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._topRaitedContainerView = new _view_top_raited_container__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._mostCommentedContainerView = new _view_most_commented_container__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._loadingView = new _view_loading__WEBPACK_IMPORTED_MODULE_6__["default"]();
    ...
    this._filmsModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_10__["ModelMethod"].UPDATE_FILM, this._onfilmUpdate);
    this._filmsModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_10__["ModelMethod"].SET_FILMS, this._onFilmsLoad);

    this._filterModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_10__["ModelMethod"].UPDATE_FILTER, this._onFilterUpdate);
  }
  ...
  init(user, container) {
    ...
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteMain.parentElement.querySelector(`.header`), this._userIconView);
  ...
  _getFilms(sortType) {
    ...
    const filteredFilms = _util_js__WEBPACK_IMPORTED_MODULE_8__["filter"][chosenFilter](films);

    const chosenSortType = sortType || this._currentSortType;
    switch (chosenSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["SortType"].DATE:
        return filteredFilms.sort((previous, current) => {
          return current.date - previous.date;
        });
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["SortType"].RAITING:
        return filteredFilms.sort((previous, current) => {
          return current.raiting - previous.raiting;
        });
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["SortType"].COMMENTS:
        return filteredFilms.sort((previous, current) => {
  ...
  _onViewAction(eventType, update) {
    switch (eventType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_10__["UserAction"].UPDATE_FILM_CATEGORY:
  ...
  _onFilmsLoad() {
    ...
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._loadingView);
    this._renderCatalog();
  }
  ...
  _clearCatalog({resetRenderedFilms = false, resetSort = false} = {}) {
    ...
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._siteSortView);
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._noFilmsView);
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._showMoreButton);
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._loadingView);
  ...
  _renderNoFilms() {
    this._noFilmsView = new _view_no_films__WEBPACK_IMPORTED_MODULE_7__["default"]();
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteMain, this._noFilmsView);
  }
  ...
  _renderSort() {
    ...
    this._siteSortView = new _view_site_sort__WEBPACK_IMPORTED_MODULE_1__["default"](this._currentSortType);
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteMain, this._siteSortView);
    this._siteSortView.setSortTypeChangeHandler(this._onSortTypeChange);
  }

  _renderCard(container, film, block) {
    const filmPresenter = new _film_card_presenter__WEBPACK_IMPORTED_MODULE_9__["default"](this._commentsModel, this._onViewAction, this._closeAllPopups);
  ...
  _renderShowMoreButton() {
    if (this._getFilms().length > Math.max(this._FILMS_STEP_LOAD, this._FILMS_CARDS_NUMBER)) {
      ...
      Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteCatalog.getElement().querySelector(`.films-list`), this._showMoreButton);
  ...
  _renderTopRaitedContainer() {
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteCatalog, this._topRaitedContainerView);
  }

  _renderMostCommentedContainer() {
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteCatalog, this._mostCommentedContainerView);
  }
  ...
  _renderTopRaitedFilms() {
    ...
    for (let i = 0; i < Math.min(this._FILMS_TOP_RAITED_CARDS_NUMBER, this._getFilms(_const_js__WEBPACK_IMPORTED_MODULE_10__["SortType"].RAITING).length); i++) {
      this._renderCard(topRaitedFilmsContainer, this._getFilms(_const_js__WEBPACK_IMPORTED_MODULE_10__["SortType"].RAITING)[i], `raited`);
    }
  }
  ...
  _renderMostCommentedFilms() {
    ...
    for (let i = 0; i < Math.min(this._FILMS_MOST_COMMENTED_CARDS_NUMBER, this._getFilms(_const_js__WEBPACK_IMPORTED_MODULE_10__["SortType"].COMMENTS).length); i++) {
      this._renderCard(mostCommentedFilmsContainer, this._getFilms(_const_js__WEBPACK_IMPORTED_MODULE_10__["SortType"].COMMENTS)[i], `commented`);
    }
  }

  _renderLoading() {
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteMain, this._loadingView);
  }
  ...
  _renderCatalog() {
    ...
    if (!(this._siteCatalog)) {
      this._siteCatalog = new _view_films_catalog__WEBPACK_IMPORTED_MODULE_2__["default"]();
    }
    ...
    this._renderSort();
    Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteMain, this._siteCatalog);
...
/* harmony import */ var _mock_const__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../mock/const */ "./src/mock/const.js");
  ...
  _onCommentAdd(evt) {
    if (evt.keyCode === 13 && evt.ctrlKey) {
      ...
      const comment = Object.assign({},
          ...
          {
            id: Object(_mock_const__WEBPACK_IMPORTED_MODULE_5__["generateId"])(),
            date: new Date(),
            author: `local user`
          });
...
/*!*********************!*\
  !*** ./src/util.js ***!
  \*********************/
/*! exports provided: getRandomInteger, createElement, render, replace, remove, isKeyPressed, updateUserPropertyArray, filter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
