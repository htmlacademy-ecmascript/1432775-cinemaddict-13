...
class Provider {
  ...
  getFilms() {
    if (Object(_util__WEBPACK_IMPORTED_MODULE_0__["isOnline"])()) {
  ...
  sync() {
    ...
    if (updatedFilms.length > 0) {
      return Object(_util__WEBPACK_IMPORTED_MODULE_0__["isOnline"])() ? this._api.sync(updatedFilms) : Promise.reject(new Error(`No connection to sync`));
    }
  ...
  addComment(comment, filmId) {
    if (!Object(_util__WEBPACK_IMPORTED_MODULE_0__["isOnline"])()) {
      Object(_util__WEBPACK_IMPORTED_MODULE_0__["renderToast"])(`Can't add comment offline`);
  ...
  deleteComment(filmId) {
    if (!Object(_util__WEBPACK_IMPORTED_MODULE_0__["isOnline"])()) {
      Object(_util__WEBPACK_IMPORTED_MODULE_0__["renderToast"])(`Can't delete offline`);
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EMOTIONS, EMOTION_PICS, SortType, CATEGORIES, UserAction, UpdateType, ModelMethod, UserRaiting */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _presenter_user_presenter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./presenter/user-presenter */ "./src/presenter/user-presenter.js");
/* harmony import */ var _presenter_catalog_presenter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./presenter/catalog-presenter */ "./src/presenter/catalog-presenter.js");
/* harmony import */ var _presenter_filters_presenter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./presenter/filters-presenter */ "./src/presenter/filters-presenter.js");
/* harmony import */ var _presenter_films_counter_presenter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/films-counter-presenter */ "./src/presenter/films-counter-presenter.js");
/* harmony import */ var _model_films_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/films-model */ "./src/model/films-model.js");
...
/* harmony import */ var _model_comments_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/comments-model */ "./src/model/comments-model.js");
/* harmony import */ var _api_api__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./api/api */ "./src/api/api.js");
/* harmony import */ var _api_provider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./api/provider */ "./src/api/provider.js");
...
const baseApi = new _api_api__WEBPACK_IMPORTED_MODULE_7__["default"](END_POINT, AUTHORIZATION);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_9__["default"](STORE_NAME, window.localStorage);
const api = new _api_provider__WEBPACK_IMPORTED_MODULE_8__["default"](baseApi, store);

const filmsModel = new _model_films_model__WEBPACK_IMPORTED_MODULE_4__["default"](api);
const filterModel = new _model_filter_model__WEBPACK_IMPORTED_MODULE_5__["default"]();
const commentsModel = new _model_comments_model__WEBPACK_IMPORTED_MODULE_6__["default"](api);
const siteMain = document.querySelector(`.main`);
const header = document.querySelector(`.header`);
const siteFooter = document.querySelector(`.footer`);
const footerStats = siteFooter.querySelector(`.footer__statistics`);

const userPresenter = new _presenter_user_presenter__WEBPACK_IMPORTED_MODULE_0__["default"](filmsModel);
userPresenter.init(header);

const filtersPresenter = new _presenter_filters_presenter__WEBPACK_IMPORTED_MODULE_2__["default"](filmsModel, filterModel);
filtersPresenter.init(siteMain);

const catalogPresenter = new _presenter_catalog_presenter__WEBPACK_IMPORTED_MODULE_1__["default"](filmsModel, filterModel, commentsModel);
catalogPresenter.init(siteMain);

const filmsCounterPresenter = new _presenter_films_counter_presenter__WEBPACK_IMPORTED_MODULE_3__["default"](filmsModel);
...
window.addEventListener(`offline`, () => {
  ...
  Object(_util__WEBPACK_IMPORTED_MODULE_10__["renderToast"])(`Lost connection`);
});
...
class CommentsModel extends _observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(api) {
    super();
    this._api = api;
    this._comments = [];
  ...
  deleteComment(commentToDelete) {
    ...
    .then(() => {
      ...
      this.notify(_const_js__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].DELETE_COMMENT, commentToDelete);
    });
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmModel; });
/* harmony import */ var _observer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./observer */ "./src/model/observer.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const */ "./src/const.js");



class FilmModel extends _observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(api) {
    super();
    this._api = api;
    this._films = [];
  ...
  setFilms(films) {
    ...
    this.notify(_const__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].SET_FILMS, films);
  }
...
class FilterModel extends _observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  updateFilter(filterType) {
    ...
    this.notify(_const__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].UPDATE_FILTER, this._filter);
  }
}
...
/* harmony import */ var _view_site_sort__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/site-sort */ "./src/view/site-sort.js");
/* harmony import */ var _view_films_catalog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/films-catalog */ "./src/view/films-catalog.js");
...
/* harmony import */ var _view_top_raited_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/top-raited-container */ "./src/view/top-raited-container.js");
/* harmony import */ var _view_most_commented_container__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/most-commented-container */ "./src/view/most-commented-container.js");
/* harmony import */ var _view_loading__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/loading */ "./src/view/loading.js");
/* harmony import */ var _view_no_films__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/no-films */ "./src/view/no-films.js");
...
class Catalog {
  constructor(filmsmodel, filterModel, commentsModel) {
    ...
    this._showMoreButton = new _view_show_more_button__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._topRaitedContainerView = new _view_top_raited_container__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._mostCommentedContainerView = new _view_most_commented_container__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._loadingView = new _view_loading__WEBPACK_IMPORTED_MODULE_5__["default"]();
    ...
    this._filmsModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_9__["ModelMethod"].UPDATE_FILM, this._onfilmUpdate);
    this._filmsModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_9__["ModelMethod"].SET_FILMS, this._onFilmsLoad);

    this._filterModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_9__["ModelMethod"].UPDATE_FILTER, this._onFilterUpdate);
  }
  ...
  _getFilms(sortType) {
    ...
    const filteredFilms = _util_js__WEBPACK_IMPORTED_MODULE_7__["filter"][chosenFilter](films);
    ...
    switch (chosenSortType) {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["SortType"].COMMENTS:
        return filteredFilms.sort((previous, current) => {
  ...
  _onFilmsLoad() {
    ...
    Object(_util_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._loadingView);
    this._renderCatalog();
  }
  ...
  _clearCatalog({resetRenderedFilms = false, resetSort = false} = {}) {
    ...
    Object(_util_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._siteSortView);
    Object(_util_js__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._noFilmsView);
  ...
  _renderNoFilms() {
    this._noFilmsView = new _view_no_films__WEBPACK_IMPORTED_MODULE_6__["default"]();
    Object(_util_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._siteMain, this._noFilmsView);
  }
  ...
  _renderSort() {
    ...
    this._siteSortView = new _view_site_sort__WEBPACK_IMPORTED_MODULE_0__["default"](this._currentSortType);
  ...
  _renderTopRaitedFilms() {
    if (this._getFilms(_const_js__WEBPACK_IMPORTED_MODULE_9__["SortType"].RAITING)[0].raiting === 0) {
      return;
    }
  ...
  _renderMostCommentedFilms() {
    if (this._getFilms(_const_js__WEBPACK_IMPORTED_MODULE_9__["SortType"].COMMENTS)[0].comments.length === 0) {
      return;
    }
  ...
  _renderLoading() {
    Object(_util_js__WEBPACK_IMPORTED_MODULE_7__["render"])(this._siteMain, this._loadingView);
  }
  ...
  _renderCatalog() {
    ...
    if (!(this._siteCatalog)) {
      this._siteCatalog = new _view_films_catalog__WEBPACK_IMPORTED_MODULE_1__["default"]();
    }
...
/***/ "./src/presenter/comment-presenter.js":
/*!********************************************!*\
  !*** ./src/presenter/comment-presenter.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _view_comment_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/comment-view */ "./src/view/comment-view.js");
...
class Comment {
  ...
  init(container) {
    ...
    this._commentView = new _view_comment_view__WEBPACK_IMPORTED_MODULE_2__["default"](this._comment);

    this._commentView.setDeleteButtonClickHandler(this._deleteComment);


    Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._commentView);
  }

  destroy() {
    Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._commentView);
  }
...
/* harmony import */ var _comment_presenter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./comment-presenter */ "./src/presenter/comment-presenter.js");
...
class CardPresenter {
  constructor(commentsModel, filmChangeCb, closePopupsCb, filterModel) {
    ...
    this._commentsModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_3__["ModelMethod"].DELETE_COMMENT, this.onCommentDelete);
    this._commentsModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_3__["ModelMethod"].ADD_COMMENT, this.addComment);
  }
  ...
  onViewAction(eventType, update) {
    switch (eventType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].DELETE_COMMENT:
        this._commentsModel.deleteComment(update)
        .catch(() => this._onCommentDeleteError(update.id));
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].ADD_COMMENT:
  ...
  _onCommentAdd(evt) {
    if (evt.keyCode === 13 && evt.ctrlKey) {
      ...
      this.onViewAction(_const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].ADD_COMMENT, comment);
    }
  }
  ...
  addComment(response) {
    if (this._popup) {
      ...
      comments.forEach((comment) => {
        const commentPresenter = new _comment_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](this.onViewAction, comment);
  ...
  _openPopup(evt) {
    evt.preventDefault();
    this._closePopups();
    this._popup = new _view_film_popup__WEBPACK_IMPORTED_MODULE_2__["default"](this._film, this.cardUpdateHandler, this._renderCommentsToPopup);
...
/***/ "./src/presenter/films-counter-presenter.js":
/*!**************************************************!*\
  !*** ./src/presenter/films-counter-presenter.js ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmsCounter; });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util.js */ "./src/util.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const */ "./src/const.js");
/* harmony import */ var _view_films_number__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/films-number */ "./src/view/films-number.js");
...
class FilmsCounter {
  constructor(filmsModel) {
    ...
    this._filmsModel.addObserver(_const__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].SET_FILMS, this._onFilmsGet);
  }
  ...
  init(container = this._container) {
    ...
    this._counterView = new _view_films_number__WEBPACK_IMPORTED_MODULE_2__["default"](this._filmNumber);

    if (!prevCounterView) {
      Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._counterView);
      return;
    }

    Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._counterView, prevCounterView);
    Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevCounterView);
  }
...
class Filters {
  constructor(filmsModel, filterModel) {
    ...
    this._filterModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].UPDATE_FILTER, this._changeFilter);
    this._filmsModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].UPDATE_FILM, this._onFilmChange);
    this._filmsModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].UPDATE_FILM_WITH_RERENDER, this._onFilmChange);
    this._filmsModel.addObserver(_const_js__WEBPACK_IMPORTED_MODULE_1__["ModelMethod"].SET_FILMS, this._onFilmChange);
  }
  ...
  init(container = this.container) {
    ...
    this._siteMenuView = new _view_site_menu__WEBPACK_IMPORTED_MODULE_0__["default"](this._filmsModel.getFilms(), this._filterModel.getFilter());
    ...
    Object(_util__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._siteMenuView, prevFiltersView);
    Object(_util__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevFiltersView);
  }

  _onViewAction(eventType, update) {
    switch (eventType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].UPDATE_FILTER:
  ...
  _onFilterChange(filterType) {
    this._onViewAction(_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].UPDATE_FILTER, filterType);
  }
}
...
/***/ "./src/presenter/user-presenter.js":
/*!*****************************************!*\
  !*** ./src/presenter/user-presenter.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util.js */ "./src/util.js");
/* harmony import */ var _view_user_icon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/user-icon */ "./src/view/user-icon.js");
...
class UserPresenter {
  constructor(filmsModel) {
    ...
    this._filmsModel.addObserver(_const__WEBPACK_IMPORTED_MODULE_2__["ModelMethod"].SET_FILMS, this._onFilmsChange);
    this._filmsModel.addObserver(_const__WEBPACK_IMPORTED_MODULE_2__["ModelMethod"].UPDATE_FILM, this._onFilmsChange);
    this._filmsModel.addObserver(_const__WEBPACK_IMPORTED_MODULE_2__["ModelMethod"].UPDATE_FILM_WITH_RERENDER, this._onFilmsChange);
  }
  ...
  init(container = this._container) {
    ...
    this._userView = new _view_user_icon__WEBPACK_IMPORTED_MODULE_1__["default"](this._userRaiting);

    if (!prevUserView) {
      Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._userView);
      return;
    }

    Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._userView, prevUserView);
    Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevUserView);
  }
  ...
  _getUserRaiting(watchedFilms) {
    if (watchedFilms > 20) {
      return _const__WEBPACK_IMPORTED_MODULE_2__["UserRaiting"].MOVIE_BUFF;
    } else if (watchedFilms > 10 && watchedFilms <= 20) {
      return _const__WEBPACK_IMPORTED_MODULE_2__["UserRaiting"].FAN;
    } else {
      return _const__WEBPACK_IMPORTED_MODULE_2__["UserRaiting"].NOVICE;
    }
  }
...
/*!*********************!*\
  !*** ./src/util.js ***!
  \*********************/
/*! exports provided: getRandomInteger, createElement, render, replace, remove, isKeyPressed, updateUserPropertyArray, filter, getDuration, isOnline, renderToast */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderToast", function() { return renderToast; });
...
const createCommentTemplate = (comment) => {
  ...
  const getFormattedTime = (date) => {
    ...
    if (difference < 1) {
      ...
      return dayjs__WEBPACK_IMPORTED_MODULE_1___default()(commentDate).format(`YYYY/MM/DD HH:mm`);
    }
  };
...
class Comment extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(comment) {
    super();
    this._comment = comment;
...
const createFilmCard = (film) => {
  ...
  <p class="film-card__info">
    ...
    <span class="film-card__duration">${Object(_util__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(duration)}</span>
        ...
        <div class="film-details__info">
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">${Object(_util__WEBPACK_IMPORTED_MODULE_3__["getDuration"])(duration)}</td>
            </tr>
            <tr class="film-details__row">
...
class FilmPopup extends _smart_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class Loading extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class NoFilms extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createSiteSort = (sortType) => {
  ...
  <li><a href="#" class="sort__button${getActiveHtmlClass(_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT)}" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}">Sort by default</a></li>
  <li><a href="#" class="sort__button${getActiveHtmlClass(_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE)}" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE}">Sort by date</a></li>
  <li><a href="#" class="sort__button${getActiveHtmlClass(_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].RAITING)}" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].RAITING}">Sort by rating</a></li>
</ul>`;
};
